<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="logeo.aspx.cs" Inherits="logeo.logeo" %>
      ...
      <table>
        <tr>
          ...
          <caption>
              ...
              <tr>
                  <td> <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
                    ...
                    <asp:CalendarExtender ID="Calendar1" PopupButtonID="imgPopup" runat="server" TargetControlID="txtfecha_nac" Format="dd/MM/yyyy">
                        </asp:CalendarExtender>
                    
                  </td>
                  <td  >
                      <asp:TextBox ID="txtfecha_nac" runat="server" Visible="False" 
                          CssClass="inputLogin" ></asp:TextBox>
                  </td>
              </tr>
              <tr>
                  ...
                  <td align="right" >
                           ...
                           <label>
                             <asp:Button ID="inputNewLogin1" runat="server" onclick="Button1_Click" Text="Ingresar" />                            
                           </label>
          ...
          <tr>
              ...
              <td align="right" >
                   <a style="color:#1172B3" href="loginpassword.aspx">&iquest;Olvido su contrase&ntilde;a?</a></td>
          </tr>
          <tr>
              <td>
                  &nbsp;</td>
